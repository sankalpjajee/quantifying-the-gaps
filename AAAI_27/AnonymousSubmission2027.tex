...
\item \textbf{An annotated corpus of 96 resources} (65 benchmarks, 31 training datasets, 139 languages), publicly released with per-resource structured summaries.\footnote{The classification criteria and per-resource structured summaries accompany this submission as supplementary material; the complete machine-readable annotation table (96 resources across all five axes) is released with a DOI upon publication and mirrored on a public dataset hub for community extension.}
